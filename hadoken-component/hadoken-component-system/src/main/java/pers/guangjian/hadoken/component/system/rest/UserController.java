...
import pers.guangjian.hadoken.component.common.enums.CodeEnum;
import pers.guangjian.hadoken.component.log.annotation.Log;
import pers.guangjian.hadoken.component.system.domain.User;
import pers.guangjian.hadoken.component.system.domain.vo.UserPassVo;
import pers.guangjian.hadoken.component.system.service.*;
...
public class UserController {
    ...
    public ResponseEntity<Object> center(@Validated(User.Update.class) @RequestBody User resources){
        if(!resources.getId().equals(SecurityUtils.getLoginUserId())){
