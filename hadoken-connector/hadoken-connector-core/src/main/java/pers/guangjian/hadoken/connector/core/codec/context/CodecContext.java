...
public interface CodecContext {
     ...
     * @param ttl     有效期
     */
    void cacheDownstream(Object key, RepayableDeviceMessage<? extends DeviceMessageResponse> message, Duration ttl);
     ...
     * @param message 下行消息
     */
    default void cacheDownstream(Object key, RepayableDeviceMessage<? extends DeviceMessageResponse> message) {
     ...
     * @param <T>    下行消息类型
     * @return 下行消息
     * @see RepayableDeviceMessage#newResponse()
     */
    <T extends RepayableDeviceMessage<? extends DeviceMessageResponse>> Optional<T> getDownstream(Object key, boolean remove);
     ...
     * @see RepayableDeviceMessage#newResponse()
     */
    default <T extends RepayableDeviceMessage<? extends DeviceMessageResponse>> Optional<T> removeDownstream(Object key) {
