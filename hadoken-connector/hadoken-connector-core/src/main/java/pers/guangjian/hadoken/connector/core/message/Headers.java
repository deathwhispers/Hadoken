...
public interface Headers {
    ...
    HeaderKey<String> responseFrom = HeaderKey.of("response-from", null, String.class);
    ...
    HeaderKey<Boolean> partialAttributes = HeaderKey.of("partialAttributes", false, Boolean.class);
