package pers.guangjian.hadoken.element.system.modules.user.service;
...
public interface UserService {
    ...
    default Map<Long, User> getUserMap(Collection<Long> ids) {
        ...
        return CollectionUtils.convertMap(getUsers(ids), User::getId);
    }
     ...
     * @return 用户列表
     */
    List<User> getUsers(UserExportReqVO reqVO);
