...
import pers.guangjian.hadoken.common.util.EncryptUtils;
...
import pers.guangjian.hadoken.element.system.service.dto.JwtUserDto;
import pers.guangjian.hadoken.element.system.service.dto.OnlineUserDto;
...
public class OnlineUserService {
    ...
    public void save(JwtUserDto jwtUserDto, String token, HttpServletRequest request) {
        ...
        redisUtils.set(properties.getTokenHeader() + token, onlineUserDto, properties.getTokenTimeout().toMinutes());
    }
    ...
    public List<OnlineUserDto> getAll(String filter) {
        List<String> keys = redisUtils.scan(properties.getTokenHeader() + "*");
    ...
    public void kickOut(String key) {
        key = properties.getTokenHeader() + key;
        redisUtils.del(key);
    }
    ...
    public void logout(String token) {
        String key = properties.getTokenHeader() + token;
        redisUtils.del(key);
    }
