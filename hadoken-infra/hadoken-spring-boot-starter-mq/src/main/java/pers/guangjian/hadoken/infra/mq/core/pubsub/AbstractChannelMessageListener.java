package pers.guangjian.hadoken.infra.mq.core.pubsub;
...
import pers.guangjian.hadoken.infra.mq.core.message.AbstractChannelMessage;
 ...
 * @Author: yanggj
 * @Description: Redis Pub/Sub 监听器抽象类，用于实现广播消费
