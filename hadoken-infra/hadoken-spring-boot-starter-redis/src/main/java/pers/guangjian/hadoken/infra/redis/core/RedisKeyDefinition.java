...
public class RedisKeyDefinition {
    ...
    private RedisKeyDefinition(String memo, String keyTemplate, KeyTypeEnum keyType, Class<?> valueType,
    ...
    public RedisKeyDefinition(String memo, String keyTemplate, KeyTypeEnum keyType, Class<?> valueType, Duration timeout) {
        this(memo, keyTemplate, keyType, valueType, TimeoutTypeEnum.FIXED, timeout);
    }

    public RedisKeyDefinition(String memo, String keyTemplate, KeyTypeEnum keyType, Class<?> valueType, TimeoutTypeEnum timeoutType) {
