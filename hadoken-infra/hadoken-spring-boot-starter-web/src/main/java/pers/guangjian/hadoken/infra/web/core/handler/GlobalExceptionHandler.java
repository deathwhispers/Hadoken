package pers.guangjian.hadoken.infra.web.core.handler;
...
public class GlobalExceptionHandler {
    ...
    public CommonResult<?> allExceptionHandler(HttpServletRequest request, Throwable ex) {
        ...
        if (ex instanceof HadokenServiceException) {
            return serviceExceptionHandler((HadokenServiceException) ex);
        }
    ...
    /**
     * 处理业务异常 HadokenServiceException
     * <p>
     * 例如说，商品库存不足，用户手机号已存在。
     */
    @ExceptionHandler(value = HadokenServiceException.class)
    public CommonResult<?> serviceExceptionHandler(HadokenServiceException ex) {
    ...
    private void initExceptionLog(ApiErrorLogCreateReqDTO errorLog, HttpServletRequest request, Throwable e) {
        ...
        errorLog.setExceptionStackTrace(ExceptionUtil.stacktraceToString(e, 500));
