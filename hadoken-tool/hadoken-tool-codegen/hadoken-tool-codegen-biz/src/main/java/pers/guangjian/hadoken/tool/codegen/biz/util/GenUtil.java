...
import static pers.guangjian.hadoken.common.util.io.FileUtil.SYS_TEM_DIR;
...
public class GenUtil {
    ...
    private static String getAdminFilePath(String templateName, GenConfig genConfig, String className, String rootPath) {
        ...
        if ("QueryCriteria".equals(templateName)) {
            return packagePath + "rest" + File.separator + "query" + File.separator + className + "QueryCriteria.java";
        }
